...
public class AccountController {
   ...
   /* Get all with archive */
    @GetMapping ("/allAll")
    public List<AccountDto> getAll(){return accountService.getAll();}
   ...
   /* Get all without Archive */
    ...
    /*Get all Archive */
    @GetMapping ("/archive")
    public List<AccountDto> getAllArchive(){return accountService.getAllArchive();}

    @GetMapping("/detail/{id}")
    public AccountDto user(@PathVariable Long id) {return accountService.findById(id);}
